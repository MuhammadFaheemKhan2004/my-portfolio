    ...
    return (
        <footer className="pb-12 pt-8">
            <div className="section-shell">
                ...
                >
                    <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Muhammad Faheem Khan</p>
                    <h3 className="mt-3 text-2xl font-bold text-slate-100 sm:text-3xl">Building elegant, high-impact software experiences.</h3>
