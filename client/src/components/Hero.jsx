        ...
        <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8">
            ...
            >
                <motion.div variants={itemVariants} className="mb-8">
                    <div className="w-32 h-32 mx-auto mb-8 rounded-full bg-gradient-to-br from-accent to-blue-600 p-1 overflow-hidden">
                ...
                <motion.h1
                    ...
                    className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-accent to-blue-400 bg-clip-text text-transparent"
                >
                ...
                >
                    Building scalable apps with Flutter, Kotlin & MERN. Specializing in real-time applications, AI integration, Firebase, REST APIs, and modern UI/UX design.
                </motion.p>
                ...
                >
                    <a
                        href="#projects"
                        className="px-8 py-3 bg-accent hover:bg-accent-hover text-white rounded-lg font-semibold transition-colors duration-300"
                    >
                        View Projects
                    </a>
                    <a
                        href="#contact"
                        className="px-8 py-3 border-2 border-accent text-accent hover:bg-accent hover:text-white rounded-lg font-semibold transition-colors duration-300"
                    >
                        Contact Me
                    </a>
                </motion.div>
